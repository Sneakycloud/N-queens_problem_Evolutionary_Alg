...
def avg_time_n_queens_solver(board_size_n, boards_per_generation, children_per_generation, mutation_rate, max_generations, itererations, ignore_0_gen, n_queen_solver):
    time_taken = []
    for i in range(itererations):
        start_time = time.process_time()
        solution_found = (n_queen_solver(board_size_n, boards_per_generation, children_per_generation, mutation_rate, max_generations))
...
def gen_size_tuner(board_size_n, boards_per_generation, children_per_generation, mutation_rate, max_generations,stop_tolerence,itererations, n_queen_solver):
    last_calibrated_gen_size = max_generations
    last_low_search_value = max_generations
    last_high_search_value = 2
    
    low_search_value = 512
    ...
    def parameter_avg_time_n_queens_solver(gen_size):
        return avg_time_n_queens_solver(board_size_n, gen_size, children_per_generation, mutation_rate, max_generations, itererations, False, n_queen_solver)
    ...
    while not is_successfull:
        ...
        for _ in range(itererations):
            solution_found = (n_queen_solver(board_size_n, low_search_value, children_per_generation, mutation_rate, max_generations))
            
            if not (solution_found[1] < max_generations):
                low_search_value *= 2
                is_successfull = False
                break
...
#finds the most optimal value for gen_size assuming all other variables are static
def child_gen_size_tuner(board_size_n, boards_per_generation, children_per_generation, mutation_rate, max_generations,stop_tolerence,itererations, n_queen_solver):
    last_calibrated_gen_size = max_generations
    last_low_search_value = max_generations
    last_high_search_value = 2
    
    low_search_value = 2
    max_search_value = children_per_generation
    high_search_value = max_search_value
    ...
    def parameter_avg_time_n_queens_solver(gen_size):
        return avg_time_n_queens_solver(board_size_n, boards_per_generation, gen_size, mutation_rate, max_generations, itererations, False, n_queen_solver)
    ...
    while not is_successfull:
        ...
        is_successfull = True
        for _ in range(itererations):
            solution_found = (n_queen_solver(board_size_n, boards_per_generation, low_search_value, mutation_rate, max_generations))
    ...
    #finds a local minimum in time taken for board sizes through a binary search
    while low_search_value != high_search_value:
        print(f"children per generations now testing: {low_search_value}, {calibrated_gen_size}, {high_search_value}")
    ...
    print(f"Optimal children per generations: {calibrated_gen_size}")
    return calibrated_gen_size
 
def mutation_rate_tuner(board_size_n, boards_per_generation, children_per_generation, mutation_rate, max_generations,stop_tolerence,itererations, n_queen_solver):
    ...
    def parameter_avg_time_n_queens_solver(new_mutation_rate):
        return avg_time_n_queens_solver(board_size_n, boards_per_generation, children_per_generation, new_mutation_rate, max_generations, itererations, True , n_queen_solver)
